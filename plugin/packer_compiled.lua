...
_G.packer_plugins = {
  ...
  ["change-colorscheme"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/change-colorscheme",
  ...
  neodim = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/neodim",
  ...
  ["nvim-tree-docs"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-tree-docs",
  ...
  onehalf = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/onehalf/vim",
  ...
  ["wxapp.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/wxapp.vim",
...
vim.o.runtimepath = vim.o.runtimepath .. ",/root/.local/share/nvim/site/pack/packer/start/onehalf/vim"
